...
public class RelatoriosConsultas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RelatoriosConsultas
     */
    ...
    // Relatório: alunos agrupados por turma (para cada turma,
    // faz um SELECT separado dos alunos daquela turma)
    ...
    // Boletim: notas de cada aluno (para cada aluno,
    // faz um SELECT separado das notas dele)
    ...
    // Média final de cada aluno, calculada no Java a partir das notas
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            while (rsAlunos.next()) {
                ...
                // busca o nome da turma desse aluno
                ...
                // busca todas as notas do aluno e calcula a média manualmente
                String sqlNotas = "SELECT nota FROM nota WHERE id_aluno=?";
                PreparedStatement stmtNotas = conn.prepareStatement(sqlNotas);
                stmtNotas.setInt(1, idAluno);
                ResultSet rsNotas = stmtNotas.executeQuery();
