 ...
 * @author guest.jb
 */
public class LancamentoNotas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LanÃ§amento de Notas");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Nota inválida! Use apenas numeros (ex: 8.5)");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LancamentoNotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LancamentoNotas().setVisible(true);
            }
        });
    }
